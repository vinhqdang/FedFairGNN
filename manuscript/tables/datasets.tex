...
All datasets strictly satisfy the Zero-Feature Leakage criterion ($\max_j \text{AUC}(x_j, y) < 0.85$). $h_s$ denotes sensitive attribute homophily. $|E|$ reports unique undirected edges; corresponding directed message-passing edge count in PyG is $2|E|$.}
\label{tab:datasets}
