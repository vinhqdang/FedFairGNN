...
non-IID model \citep{hsu2019measuring}; smaller $\alpha$ is more skewed.
...
\citep{dwork2014algorithmic}. We protect the \emph{sensitive attribute}:
...
\citep{mironov2017renyi}. For the Gaussian mechanism with noise multiplier
...
scaling/model-replacement \citep{bagdasaryan2020backdoor}), the strong
omniscient attacks ALIE \citep{baruch2019little} and IPM \citep{xie2019fall},
