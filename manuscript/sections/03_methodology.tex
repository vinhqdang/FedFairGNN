...
\subsubsection*{Privacy Accounting and Utility Preservation}
...
\begin{algorithmic}[1]
\STATE \textbf{Input:} Client gradients $\{g_k\}$, metrics $\{perf_k, dpd_k\}$ (where $perf_k$ represents task utility such as AUC, and $dpd_k$ is the demographic parity difference defined in Eq. 1), budget $\tau$
