...
\textbf{FU-Shapley (M1)} \textit{(ReLU gate)} & 0.0000 / 0.6512 & 0.0000 / 0.6327 & 0.0309 / 0.6390 & 0.2008 / ---$^{2}$ \\
\textbf{robust FU-Shapley} \textit{(ReLU gate + median screen)} & 0.0000 / 0.6486 & 0.0000 / 0.6313 & 0.0000 / 0.6372 & 0.0000 / 0.6302 \\
